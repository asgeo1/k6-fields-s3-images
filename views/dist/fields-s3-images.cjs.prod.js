...
var utils = require('../../dist/utils-0719d5aa.cjs.prod.js');
...
function Field({
  ...
  return core.jsx(fields.FieldContainer, {
    ...
    onCancel: () => {
      onChange === null || onChange === void 0 || onChange(value.previous);
    }
  }) : core.jsx(ImgView, {
  ...
  return value.kind === 'from-server' || value.kind === 'upload' ? core.jsx(core.Stack, {
    ...
    onClick: () => {
      if (value.previous !== undefined) {
        onChange === null || onChange === void 0 || onChange(value === null || value === void 0 ? void 0 : value.previous);
      }
    }
...
function validateRef({
  ...
  if (!utils.parseImagesMetaRef(ref)) return;
  if (!utils.parseImageRef(ref)) return;
  return 'Invalid ref';
}
